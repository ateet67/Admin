import { ManufacturerService } from './maufacturer.service';
...
import {
  manufacturerSortableDirectives,
  SortEvent,
} from './manufacturer-sortable.directives';
import { Table } from './manufacturer.modal';
...
@Component({
  ...
  styleUrls: ['./manufacturer.component.scss'],
  providers: [ManufacturerService, DecimalPipe],
})
export class ManufacturerComponent implements OnInit {
  ...
  @ViewChildren(manufacturerSortableDirectives)
  headers!: QueryList<manufacturerSortableDirectives>;
